...
<script type="text/javascript">
	...
	function InitTable(pageIndex) {
		...
		$
				.ajax({
					url : "ads/getAddsList/" + currentPageVar,
					data : {
								...
								$("#table_ads")
										.append(
												"<tr>'"
														...
														+ "</td>"
														+ "<td>"
														+ data.result[i].shuoming
														+ "</td>"
														+ "<td>"
														+ "<a href='"+data.result[i].tupian+"' target='_blank'><img width='150' height='150' src='"
															+data.result[i].tupian+"' align='middle''></a>"
														+ "</td>" + "</tr>");
							}
							//显示分布按钮							
					...
					<div class="span10">
						<form class="form-inline" onsubmit="return false;">
							...
							<input class="input-xlarge"
								style="float: right; margin-right: 10px" placeholder="请输入商户名称"
