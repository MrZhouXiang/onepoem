		...
		$.ajax({
					...
					success : function(data) {
						if (data.success) {
							...
							$("#pay_account").val(data.result.zhifuzhanghu);
							$("#bank_card_no").val(data.result.bank_card_no);
							$("#issuing_bank").val(data.result.issuing_bank);
							$("#vip_lv").val(data.result.vipdengji);
							$('#identity').val(data.result.identity);
							$('#belong').val(data.result.belong);
							$('#province').val(data.result.province);
							$('#city').val(data.result.city);
							$('#is_international_academy').val();
	...
	function save_memberChange() {
		...
		$.ajax({
			...
			data : {
				...
				zhifuzhanghu: $("#pay_account").val(),
				vipdengji: $("#vip_lv").val(),
...
<body onload="loadPage()">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span10">
				<h2>
					商户详情<a href="javascript:history.go(-1);"
						...
						<div class="row-fluid">
							<div class="span12">
								<div class="row-fluid">
									<div class="span4">
										<form id="tab">
											<label>用户名</label> <input type="text" value="" id="username"
												class="input-xlarge"> 
											<label>性别</label> 
											...
											<label>等级</label> <input type="text" value="" id="lv"
										...
										<div class="btn-toolbar">
											...
											<a href="#" class="btn" id="frozenBtn">冻结</a>
											<a href="#" class="btn" id="unlockBtn" onclick="unlockUser()">解冻</a>
									...
									<div class="span4">
										<form>
											 <label>状态</label> <input
												type="text" value="" id="status" class="input-xlarge" readonly="readonly">
											<label>支付宝账号</label> <input type="text" value="" id="pay_account"
												class="input-xlarge">
											<label>银行卡号</label> <input type="text" value="" id="bank_card_no"
												class="input-xlarge">
											<label>发卡行</label> <input type="text" value="" id="issuing_bank"
												class="input-xlarge">
											<label>VIP等级</label> <input type="text" value="" id="vip_lv"
												class="input-xlarge">
											<label>省</label>
				...
				<div class="modal small hide fade" id="frozenModal" tabindex="-1"
					...
					<div class="modal-body">
						<form id="tab">
						<label>冻结天数</label> <input type="text" value="" id="days" class="input-xlarge">
						</form>
					</div>
