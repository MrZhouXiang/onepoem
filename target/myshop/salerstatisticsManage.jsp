...
<script type="text/javascript">
	...
	function getUserDataCount() {
		$.ajax({
			url : "salerstatistics/getUserDataCount/",
			data : {
				keyword1 : keyword1,
				keyword2 : keyword2,
				keyword3 : keyword3,
	...
	function getDesignerDataCount() {
		$.ajax({
			url : "salerstatistics/getDesignerDataCount/",
			data : {
				keyword1 : keyword1,
				keyword2 : keyword2,
				keyword3 : keyword3,
	...
	function getUserBillDataCount() {
		$.ajax({
			url : "salerstatistics/getUserBillDataCount/",
			data : {
				keyword1 : keyword1,
				keyword2 : keyword2,
				keyword3 : keyword3,
	...
	function getOrderDataCount() {
		$.ajax({
			url : "salerstatistics/getOrderDataCount/",
			data : {
				keyword1 : keyword1,
				keyword2 : keyword2,
				keyword3 : keyword3,
	...
	function getWorksheetDataCount() {
		$.ajax({
			url : "salerstatistics/getWorksheetDataCount/",
			data : {
				keyword1 : keyword1,
				keyword2 : keyword2,
				keyword3 : keyword3,
	...
	function getBuyoutDataCount() {
		$.ajax({
			url : "salerstatistics/getBuyoutDataCount/",
			data : {
				keyword1 : keyword1,
				keyword2 : keyword2,
				keyword3 : keyword3,
	...
	function getPraiseAndDiscussDataCount() {
		$.ajax({
			url : "salerstatistics/getPraiseAndDiscussDataCount/",
			data : {
				keyword1 : keyword1,
				keyword2 : keyword2,
				keyword3 : keyword3,
