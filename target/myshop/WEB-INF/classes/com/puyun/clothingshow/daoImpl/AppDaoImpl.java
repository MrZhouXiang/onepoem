...
import com.puyun.clothingshow.base.DateUtil;
...
import com.puyun.clothingshow.entity.StandardSize;
...
public class AppDaoImpl extends BaseDaoImpl implements AppDao
{
    ...
    public User login(String tel, String password)
    {
        ...
        List<User> list =
            jdbcTemplate.query(sql, new Object[] {tel, password}, new BeanPropertyRowMapper<User>(User.class));
    ...
    {
        String sql1 = "insert into login(LoginName,Tel,Password) " + "values(:LoginName,:Tel,:Password)";
        GeneratedKeyHolder generatedKeyHolder = new GeneratedKeyHolder();
        this.namedJdbcTemplate.update(sql1, new BeanPropertySqlParameterSource(user), generatedKeyHolder);
    ...
    public User getUser(String tel)
    {
        ...
        List<User> list = jdbcTemplate.query(sql, new Object[] {tel}, new BeanPropertyRowMapper<User>(User.class));
        return list.size() > 0 ? list.get(0) : null;
    }
    ...
    public String getBuyerId(String loginId)
    {
        ...
        List<Buyer> list =
            jdbcTemplate.query(sql, new Object[] {loginId}, new BeanPropertyRowMapper<Buyer>(Buyer.class));
        if (list.size() > 0)
        {
    ...
    public String getSalerId(String loginId)
    {
        ...
        List<Saler> list =
            jdbcTemplate.query(sql, new Object[] {loginId}, new BeanPropertyRowMapper<Saler>(Saler.class));
        if (list.size() > 0)
        {
    ...
    {
        String sql = "SELECT lk.ID AS id, "
        					+"lk.UserName AS NAME, "
        					+"lk.TouxiangID, "
        					+"lk.Dengji AS lv, "
        					+"lk.weiboName AS weibo_name, "
        					+"lk.weixinName AS weixin_name, "
        					+"lk.NameCs AS NameCs, "
        					+"l.Tel AS tel "
        					+"FROM "
        					+"loginkehu lk "
        					+"RIGHT JOIN login l ON lk.LoginID = l.ID "
        					+"WHERE "
        					+"lk.ID = ? ";
        ...
        String sql1 =
            "select ID as id,loginID,name,Shengao as height,Tizhong as weight,Chima as normal_size,Yaowei as waist,Xiongwei as bust,Tunwei as hip,Miaoshu as description from yonghuchima where LoginID=?";
        List<UserSize> size_list =
            jdbcTemplate.query(sql1, new Object[] {id}, new BeanPropertyRowMapper<UserSize>(UserSize.class));
        if (buyer != null)
        {
    ...
    public Saler getSalerInfo(String id)
    {
        ...
        List<Address> addressList =
            jdbcTemplate.query(sql1, new Object[] {id}, new BeanPropertyRowMapper<Address>(Address.class));
    ...
    {
        String sql2 =
            "SELECT jy.*,lx.`Name` as ZhizuoLxName FROM zhizuojingyan as jy RIGHT JOIN zhizuoleixing as lx ON jy.ZhizuoLxID = lx.ID WHERE YonghuID = ? AND YonghuLx = 'shanghu' ORDER BY jy.ZhizuoLxID ASC";
        List<LVBean> dengji_list =
            jdbcTemplate.query(sql2, new Object[] {saler.getId()}, new BeanPropertyRowMapper<LVBean>(LVBean.class));
        int dengji_all = 0;
        int jingyan_all = 0;
        int jingyan_temp = 0;
        ...
        String sql3 =
                "SELECT jy.*,lx.`Name` as ZhizuoLxName FROM zhizuojingyan as jy RIGHT JOIN zhizuoleixing as lx ON jy.ZhizuoLxID = lx.ID WHERE YonghuID = ? AND YonghuLx = 'shanghu' AND jy.ZhizuoLxID='0'";
            List<LVBean> list =
                jdbcTemplate.query(sql3, new Object[] {saler.getId()}, new BeanPropertyRowMapper<LVBean>(LVBean.class));
    ...
    public String getUserAvatarUrl(String id, String types)
    {
        ...
        List<UserAvatar> list =
            jdbcTemplate.query(sql, new Object[] {id, types}, new BeanPropertyRowMapper<UserAvatar>(UserAvatar.class));
        if (list.size() > 0)
        {
    ...
    public List<GoodsType> getAllGoodsTypes()
    {
        ...
        List<GoodsType> list =
            jdbcTemplate.query(sql, new Object[] {}, new BeanPropertyRowMapper<GoodsType>(GoodsType.class));
        return list;
    }
     ...
     */
    @Override
    public List<GoodsForApp> getGoodsList3(String types, int page_num, int page_size, String orderby, int hascomment,
        int comment_size, int yonghuid, int zhizuolx)
    {
        // 时间
        ...
        String sql =
            "select * from shangpin where ((Leixing IN ('shejixiu','jiagongdan','dingzhidan') AND FabuzheLx = 'shanghu') OR (Leixing IN ('chengyixiu') AND FabuzheLx = 'kehu')) "
                + zhizuolx_where
        ...
        List<GoodsForApp> list = jdbcTemplate.query(sql, new BeanPropertyRowMapper<GoodsForApp>(GoodsForApp.class));
        for (GoodsForApp goods : list)
        {
            String sql1 = "select Url as url,IsGongkai as isGongkai from shangpintupian where ShangpinID=?";
            List<GoodsPhoto> photoList =
                jdbcTemplate.query(sql1, new Object[] {goods.getId()}, new BeanPropertyRowMapper<GoodsPhoto>(
                    GoodsPhoto.class));
            if (photoList.size() > 0)
            {
            ...
            if (UserType.BUYER.getValue().equals(goods.getFabuzhelx()))
            {
                ...
                List<Buyer> buyerList =
                    jdbcTemplate.query(sql2, new Object[] {goods.getFabuzheid()}, new BeanPropertyRowMapper<Buyer>(
                        Buyer.class));
                if (buyerList.size() > 0)
                {
            ...
            else
            {
                ...
                List<Saler> salerList =
                    jdbcTemplate.query(sql2, new Object[] {goods.getFabuzheid()}, new BeanPropertyRowMapper<Saler>(
                        Saler.class));
                if (salerList.size() > 0)
                {
    ...
    public float getNanduxishu(int zhizuoLx)
    {
        ...
        nanduxishu = jdbcTemplate.queryForObject(sql, Float.class, new Object[] {zhizuoLx});
        return nanduxishu;
    }
    ...
    public int getJiagongfei(int lv)
    {
        ...
        int jiagongfei = jdbcTemplate.queryForObject(sql2, Integer.class, new Object[] {lv});
     ...
     */
    @Override
    public List<GoodsForApp> getGoodsList(String types, int page_num, int page_size, String orderby, int hascomment,
        int comment_size, int yonghuid, int zhizuolx)
    {
        // TODO Auto-generated method stub
        int start = (page_num - 1) * page_size;
        ...
        // 时间
        sql =
            "SELECT sp.* FROM shangpin AS sp RIGHT JOIN loginshanghu AS sh ON sp.FabuzheID = sh.ID WHERE FabuzheLx = 'shanghu' and Leixing in(?) and Shuliang > 0 and IsXiajia !=1 "
                + zhizuolxStr
                + " ORDER BY now() - sp.RukuSj < 10000 DESC,IF ((now() - sp.RukuSj < 10000) = 1,sh.VIPDengji,sp.RukuSj) DESC,sp.RukuSj DESC limit "
                + start + "," + page_size;
        List<GoodsForApp> list =
            jdbcTemplate.query(sql, new Object[] {types}, new BeanPropertyRowMapper<GoodsForApp>(GoodsForApp.class));
        for (GoodsForApp goods : list)
        {
            String sql1 = "select Url as url,IsGongkai as isGongkai from shangpintupian where ShangpinID=?";
            List<GoodsPhoto> photoList =
            ...
            if (hascomment == 1)
            {
                List<Comment> commentList = getCommentList(goods.getId(), 1, 4, "shangpin");
    ...
    @Override
    public List<HistoryShowForApp> getHistoryShowForApp(String types, int page_num, int page_size, String orderby,
        int hascomment, int comment_size, int yonghuid)
    {
        int start = (page_num - 1) * page_size;
        String sql =
            "select *,DATE_FORMAT(NOW(),'%j')-DATE_FORMAT(RukuSj,'%j') as days,DATE_FORMAT(NOW(),'%u')-DATE_FORMAT(RukuSj,'%u') as weeks,DATE_FORMAT(NOW(),'%m')-DATE_FORMAT(RukuSj,'%m') as months from shangpin where Leixing in ('shejixiu','chengyixiu') and FabuzheID="
                + yonghuid
                + " and IsMaiduan !=1 "
                + " and IsXiajia=0 "
                ...
                + start
                + "," + page_size;
        List<HistoryShowForApp> list =
            jdbcTemplate.query(sql, new BeanPropertyRowMapper<HistoryShowForApp>(HistoryShowForApp.class));
    ...
    @Override
    public List<HistoryShowForApp> getHistoryShowForApp2(String types, int page_num, int page_size, String orderby,
        int hascomment, int comment_size, int yonghuid)
    {
        int start = (page_num - 1) * page_size;
        String sql =
...
//                }
     ...
     */
    @Override
    public List<GoodsForApp> getDesignerShowList(String types, int page_num, int page_size, String orderby,
        int hascomment, int comment_size, int id)
    {
        int start = (page_num - 1) * page_size;
        String sql = "";
        // 时间
        if ("sj".equals(orderby))
        {
            sql = "select * from shangpin where Leixing=? order by RukuSj" + " desc limit " + start + "," + page_size;
            // 价格
        }
        else
        {
            sql = "select * from shangpin where Leixing=? order by Jiage" + " desc limit " + start + "," + page_size;
        }
        List<GoodsForApp> list =
            jdbcTemplate.query(sql, new Object[] {types}, new BeanPropertyRowMapper<GoodsForApp>(GoodsForApp.class));
        for (GoodsForApp goods : list)
    ...
    @Override
    public boolean postComment(String commenter_id, String to_commenter_id, String types, String content,
        String pinglunrenLx)
    {
        // TODO Auto-generated method stub
        String sql = "";
        sql =
            "insert into pinglun(PinglunRenID,PinglunDxID,Leixing,Neirong,RukuSj,PinglunrenLx) values(?,?,?,?,Now(),?)";
        int num = jdbcTemplate.update(sql, commenter_id, to_commenter_id, types, content, pinglunrenLx);
    ...
    @Override
    public boolean postGoodsComment(String order_id, String shangpin_id, int pingfen, String content, String user_id,
        String utypes)
    {
        // TODO Auto-generated method stub
        boolean flag = false;
        String sql =
            "insert into dingdanchanpinpingjia(Dingdanid,Chanpinid,Pingfen,Content,Userid,YonghuLx,RukuSj) values(?,?,?,?,?,?,Now())";
        int num = jdbcTemplate.update(sql, order_id, shangpin_id, pingfen, content, user_id, utypes);
        if (num > 0)
        {
            // 修改订单状态为已评价
    ...
    @Override
    public List<Comment> getCommentList(String id, int page_num, int page_size, String types)
    {
        // TODO Auto-generated method stub
        int start = (page_num - 1) * page_size;
        String typeStr = "";
        ...
        String sql =
            "select PinglunRenID as userId,Neirong as content,PinglunrenLx as userType ,RukuSj as createDate from pinglun where PinglunDxID=? "
                + typeStr + "order by RukuSj desc limit " + start + "," + page_size;
        
        List<Comment> list =
            jdbcTemplate.query(sql, new Object[] {id}, new BeanPropertyRowMapper<Comment>(Comment.class));
        for (Comment comment : list)
        {
            if (UserType.BUYER.getValue().equals(comment.getUserType()))
            {
                ...
                List<Buyer> buyerList =
                    jdbcTemplate.query(sql1, new Object[] {comment.getUserId()}, new BeanPropertyRowMapper<Buyer>(
                        Buyer.class));
            ...
            else
            {
                ...
                List<Saler> buyerList =
                    jdbcTemplate.query(sql2, new Object[] {comment.getUserId()}, new BeanPropertyRowMapper<Saler>(
                        Saler.class));
                if (buyerList != null && buyerList.size() > 0)
                {
    ...
    public GoodsForApp getGoodsDetail(String id)
    {
        ...
        List<GoodsForApp> list =
            jdbcTemplate.query(sql, new Object[] {id}, new BeanPropertyRowMapper<GoodsForApp>(GoodsForApp.class));
    ...
    public List<GoodsPhoto> getGoodsPhotoList2(String id)
    {
        ...
        List<GoodsPhoto> list =
            jdbcTemplate.query(sql, new Object[] {id}, new BeanPropertyRowMapper<GoodsPhoto>(GoodsPhoto.class));
        // int size = list.size();
    ...
    public int submitOrder(OrderForApp order)
    {
        ...
        // 生成订单号
        String Bianhao = DateUtil.getDate(DateUtil.YYYY_MM_DD_HHMMSSSSS) + "-" + Utils.random6();
        ...
        if (UserType.BUYER.getValue().equals(order.getMaijiaLx()))
        {
            ...
            List<Buyer> buyerList =
                jdbcTemplate.query(buyerUsernameSql,
        ...
        List<Saler> salerList =
            jdbcTemplate.query(salerUsernameSql, new Object[] {order.getMmaijiaID()}, new BeanPropertyRowMapper<Saler>(
                Saler.class));
        if (salerList.size() > 0)
        {
            Saler saler = salerList.get(0);
        ...
        {// 非抢单需要判断数量
            if (goodsNum > 0)
            {
                ...
                num1 = namedJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(order), generatedKeyHolder);
                flag = num1 > 0;
                // 订单失效时间为30min
            }
        }else {
    ...
    public String getNBBuyerId(OrderForApp order)
    {
        ...
        String id = null;
        String sql =
            "SELECT a.ID,a.VIPDengji,b.JiagongSj,b.ID as dingdanID FROM loginshanghu AS a RIGHT JOIN dingdan AS b ON a.ID = b.MmaijiaID WHERE"
                + " b.ShangpinID = "
                + order.getShangpinID()
                + " AND b.IsQiangdan = 1"
    ...
    public boolean updateBuyer(Buyer buyer)
    {
        // 根据买家登录id修改买家信息
        String sql =
            "update loginkehu set LoginID=:loginId,UserName=:name,Xingbie=:xingbie " + "where LoginID=:loginId";
        GeneratedKeyHolder generatedKeyHolder = new GeneratedKeyHolder();
        int num = this.namedJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(buyer), generatedKeyHolder);
        // 更新买家尺寸列表
    ...
    public int addBuyer(Buyer buyer)
    {
        ...
        // 插入新买家信息
        String sql =
            "insert into loginkehu(LoginID,UserName,Xingbie,create_time) " + "values(:loginId,:name,:xingbie,NOW())";
        GeneratedKeyHolder generatedKeyHolder = new GeneratedKeyHolder();
        int num = this.namedJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(buyer), generatedKeyHolder);
        ...
        if (num > 0)
        {
            try
            {
                ...
                StandardSize standardSize = getStandardSize(buyer.getXingbie(), buyer.getSize_list().get(0).getNormal_size());
                // 增加用户尺寸
                String sql2 = "insert into yonghuchima(LoginID,Name,Chima,Shengao,Yaowei,Tunwei,Xiongwei,shoulder_breadth) " + "values('" + buyer.getLoginId() + "','" + "尺码一" + "','"
                        + buyer.getSize_list().get(0).getNormal_size() + "','"  + standardSize.getHeight() + "','" + standardSize.getWaist() + "','"
                		+ standardSize.getHip() + "','" + standardSize.getBust() + "','" + standardSize.getShoulder_breadth()  + "')";
    ...
    public int addMySize(UserSize size)
    {
        // 增加用户尺寸
        String sql =
            "insert into yonghuchima(LoginID,Name,Chima,Shengao,Tizhong,Yaowei,Tunwei,Xiongwei,Miaoshu) values(:loginId,:name,:normal_size,:height,:weight,:waist,:hip,:bust,:description)";
        GeneratedKeyHolder generatedKeyHolder = new GeneratedKeyHolder();
        this.namedJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(size), generatedKeyHolder);
    ...
    {
        String sql =
            "select ID as id,LoginID as loginId,Name as name,Chima as normal_size,Shengao as height,Tizhong as weight,Yaowei as waist,Tunwei as hip,Xiongwei as bust,Miaoshu as description from yonghuchima where LoginId=?";
        List<UserSize> list =
            jdbcTemplate.query(sql, new Object[] {loginid}, new BeanPropertyRowMapper<UserSize>(UserSize.class));
        return list;
    }
    ...
    public int addSaler(Saler saler)
    {
        ...
        // 插入新卖家信息
        String sql =
            "insert into loginshanghu(LoginID,UserName,Quyu,ZhifuZhanghu,create_time,bank_card_no,issuing_bank) "
                + "values(:loginId,:name,:quyu,:zhifuzhanghu,now(),:bank_card_no,:issuing_bank)";
        GeneratedKeyHolder generatedKeyHolder = new GeneratedKeyHolder();
        int num = this.namedJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(saler), generatedKeyHolder);
        if (num > 0)
        {
            try
            {
     ...
     */
    @Override
    public List<OrderForApp> getOrderList(String types, int userid, String status, int page_num, int page_size,
        int shangpinid, String leixing)
    {
        int start = (page_num - 1) * page_size;
        String sql = "";
        String whereStr = "";
        ...
        if ("mj".equals(types))
        {
            ...
            if (status.equals("16"))
            {// 获取已买断
                whereStr = "a.MaijiaID = " + userid + " and a.MaijiaLx = '" + leixing + "'";
            }
            else
            {
                whereStr = "a.MaijiaID = " + userid + " and a.MaijiaLx = '" + leixing + "' and d.Leixing !='shejixiu'";
            }
        }
        //卖家
        else
        {
            if (status.equals("1"))
            {// 获取已抢订单
                whereStr = "a.MmaijiaID = " + userid + " and a.MmaijiaLx = '" + leixing + "' and isQiangDan = '1'";
            }
            else if (status.equals("16"))
            {// 获取已买断
                whereStr = "a.MmaijiaID = " + userid + " and a.MmaijiaLx = '" + leixing + "'";
            }
            else
            {
                whereStr =
                    "a.MmaijiaID = " + userid + " and a.MmaijiaLx = '" + leixing + "' and d.Leixing !='shejixiu'";
            }
            
        }
        sql =
            "SELECT" + " a.id AS id,a.buyer_username as mjname,a.saler_username as mmjname,a.danjia AS danjia,"
                + "a.Bianhao AS bianhao," + "a.ShangpinID AS shangpinid," + "a.MaijiaID," + "a.MmaijiaID,"
                + "a.MaijiaLx," + "a.MmaijiaLx," + "a.KuaidiFs as KuaidiFs," + "d.Leixing AS shangpinlx,"
                + " d.Mingcheng AS mingcheng," + "a.Shuliang AS shuliang,"
                + " a.zongjia AS zongjia" + ",a.RukuSj " + ",a.Zhuangtai,a.IsQiangdan,a.Tuikuanzht " + " FROM " + "dingdan AS a"
                + " RIGHT JOIN shangpin AS d ON a.ShangpinID = d.ID " + " WHERE " + whereStr + " and a.Zhuangtai in ("
                + status + ")  order by a.RukuSj " + " desc limit " + start + "," + page_size;
        List<OrderForApp> list = jdbcTemplate.query(sql, new BeanPropertyRowMapper<OrderForApp>(OrderForApp.class));
        for (OrderForApp goods : list)
        {
            String sql1 = "select Url as url,IsGongkai as isGongkai from shangpintupian where ShangpinID=?";
            List<GoodsPhoto> photoList =
                jdbcTemplate.query(sql1, new Object[] {goods.getShangpinID()}, new BeanPropertyRowMapper<GoodsPhoto>(
                    GoodsPhoto.class));
            ...
            int count = jdbcTemplate.queryForObject(countSql, new Object[]{goods.getShangpinID()}, Integer.class);
            ...
            try
            {
            	List<String> buyerNameList = jdbcTemplate.queryForList(sql2, String.class, new Object[] {goods.getMaijiaID()});
            ...
            {
            	List<String> salerNameList = jdbcTemplate.queryForList(sql3, String.class, new Object[] {goods.getMmaijiaID()});
     ...
     */
    @Override
    public List<BuyerForOrder> getBuyerList(String id, int page_num, int page_size, String orderby)
    {
        int start = (page_num - 1) * page_size;
        String sql =
            "SELECT a.ID AS userId,b.ID AS dingdanID, a.UserName as UserName,a.Dengji,b.Youhuijia,b.KuaidiFs,b.jiagongSj,b.Zhuangtai as zhuangTai,b.Tuikuanzht as tuikuanzht "
                + " FROM loginshanghu AS a JOIN dingdan AS b ON b.MmaijiaID = a.ID WHERE b.ShangpinID = " + id
                + " AND b.Zhuangtai in (1,0) "
                + " AND (a.unlock_time < NOW() OR a.unlock_time IS NULL) "
                + " ORDER BY b.Zhuangtai DESC,a.Dengji DESC,b.jiagongSj ASC,b.KuaidiFs ASC,b.RukuSj ASC "
                + " limit " + start + "," + page_size;
        List<BuyerForOrder> list =
            jdbcTemplate.query(sql, new BeanPropertyRowMapper<BuyerForOrder>(BuyerForOrder.class));
    ...
    public OrderForApp getOrderInfo(String id)
    {
        String sql =
            "SELECT"
                ...
                + " a.Shouhuodizhi AS shouhuodizhi,a.JiagongSj as JiagongSj," + " a.Bianhao AS bianhao,"
                + "a.ShangpinID AS shangpinid," + "a.MaijiaID," + "a.MmaijiaID," + " a.MaijiaLx," + "a.MmaijiaLx,"
                + "d.Leixing AS shangpinlx," + " d.Mingcheng AS mingcheng," + " a.danjia AS danjia,"
                + "a.Shuliang AS shuliang," + " a.Youhuijia AS youhuijia," + " a.zongjia AS zongjia,"
                + " a.Zhuangtai AS zhuangtai, " + " a.RukuSj AS RukuSj, " + " a.KuaidiFs AS KuaidiFs, "
                + " a.Shoukuanma AS Shoukuanma, " + " a.payCode AS payCode,a.FahuoSj as FahuoSj, "
                + " a.FukuanSj AS FukuanSj, d.ZhizuoLx as ZhizuoLx" + " FROM " + "dingdan AS a "
                + " RIGHT JOIN shangpin AS d ON a.ShangpinID = d.ID" + " WHERE " + "a.ID = " + id;
        OrderForApp mOrderForApp =
            jdbcTemplate.queryForObject(sql, new BeanPropertyRowMapper<OrderForApp>(OrderForApp.class));
        // 查询出商品图片
        String sql1 = "select Url as url,IsGongkai as isGongkai from shangpintupian where ShangpinID=?";
        List<GoodsPhoto> photoList =
        ...
        List<String> list1 = jdbcTemplate.queryForList(sql2, new Object[] {mOrderForApp.getMaijiaID()}, String.class);
        ...
        List<String> list2 = jdbcTemplate.queryForList(sql3, new Object[] {mOrderForApp.getMmaijiaID()}, String.class);
     ...
     * 
     * @param id
     * @param status 0：待付款，未选择,1：待付款，已选择 ,2：已取消 4：已付款 8：待发货 32：已发货 64:已收货 128：待评价 256：已评价
     * @return
     */
    @Override
     ...
     */
    @Override
    public int modifyOrderStatus(String id, int status, int kuaidiID, String kuaididanhao)
    {
    	int num = 0;
    	OrderForApp order = getOrderInfo(id);
    ...
    public int makerSureToReceipt(String id, String pay_id)
    {
    	OrderForApp order = getOrderInfo(id);
    	int num = 0;
    	if("32".equals(order.getZhuangtai()) || "512".equals(order.getZhuangtai())){
    ...
    {
        String sql =
            "insert into shouhuodizhi(YonghuID,YonghuLx,Shouhuoren,ShouhuoDizhi,Dianhua,Youbian,Shengshiqu) values(:yonghuid,:yonghulx,:shouhuoren,:shouhuodizhi,:dianhua,:youbian,:shengshiqu)";
        GeneratedKeyHolder generatedKeyHolder = new GeneratedKeyHolder();
        this.namedJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(address), generatedKeyHolder);
        return generatedKeyHolder.getKey().intValue();
    }
    ...
    {
        String sql =
            "update shouhuodizhi set Shouhuoren=:shouhuoren,ShouhuoDizhi=:shouhuodizhi,Dianhua=:dianhua,Youbian=:youbian,Shengshiqu=:shengshiqu where ID=:id";
        int num = namedJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(address));
        return num;
    }
    ...
    public List<Ads> getAdsList(String types, String point)
    {
        ...
        List<Ads> adsList =
            jdbcTemplate.query(sql1, new Object[] {types, point}, new BeanPropertyRowMapper<Ads>(Ads.class));
        return adsList;
    }
    ...
    public List<Express> getExpressList()
    {
        ...
        List<Express> expressList =
            jdbcTemplate.query(sql1, new Object[] {"kuaidi"}, new BeanPropertyRowMapper<Express>(Express.class));
        return expressList;
    }
    ...
    public int addGoods(GoodsForApp goods)
    {
        ...
        GeneratedKeyHolder generatedKeyHolder = new GeneratedKeyHolder();
        this.namedJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(goods), generatedKeyHolder);
        if (goods.getUrl_list().length > 0)
        {
            ...
            for (int i = 0; i < l; i++)
            {
                // 保存地址
                String sql2 =
                    "insert into shangpintupian(ShangpinID,Url,IsGongkai,JubaoZt,JubaoCs,ShanchuZt,RukuSj,TupianMc) values(:shangpinId,:url,:isGongkai,:jubaoZt,:jubaoCs,:shanChuZt,now(),:tupianMc)";
                ...
                this.namedJdbcTemplate.update(sql2, new BeanPropertySqlParameterSource(gp), generatedKeyHolder2);
    ...
    @Override
    public List<MouldForApp> getMouldList(String id, int page_num, int page_size, String orderby)
    {
        int start = (page_num - 1) * page_size;
        String sql = "";
        // 时间
        ...
        {
            sql =
                "SELECT ID,Name,Jiage,ZhizuoLxID,description FROM muban WHERE ZhizuoLxID = " + id + " order by ID desc limit " + start + ","
                    + page_size;
        ...
        else
        {
            // 价格
            sql =
                "SELECT ID,Name,Jiage,ZhizuoLxID,description FROM muban WHERE ZhizuoLxID = " + id + " order by b.Jiage desc limit "
                 + start + "," + page_size;
        }
        List<MouldForApp> list = jdbcTemplate.query(sql, new BeanPropertyRowMapper<MouldForApp>(MouldForApp.class));
        for (MouldForApp goods : list)
        {
            String sql1 = "select * from mubantupian where MubanID=?";
            List<MuBanTupian> urllist =
                jdbcTemplate.query(sql1, new Object[] {goods.getID()}, new BeanPropertyRowMapper<MuBanTupian>(
                    MuBanTupian.class));
            if (urllist.size() > 0)
            {
    ...
    public MouldForApp getMouldDetail(String id)
    {
        ...
        List<MouldForApp> list =
            jdbcTemplate.query(sql, new Object[] {id}, new BeanPropertyRowMapper<MouldForApp>(MouldForApp.class));
        MouldForApp mMouldForApp = list.size() > 0 ? list.get(0) : null;
        if (mMouldForApp != null)
        {
            String sql1 = "select * from mubantupian where MubanID=?";
            List<MuBanTupian> urllist =
                jdbcTemplate.query(sql1, new Object[] {id}, new BeanPropertyRowMapper<MuBanTupian>(MuBanTupian.class));
            if (urllist != null)
            {
    ...
    public List<ColorForApp> getColors()
    {
        ...
        List<ColorForApp> mColorList =
            jdbcTemplate.query(sql, new BeanPropertyRowMapper<ColorForApp>(ColorForApp.class));
        
        return mColorList;
    }
    
    @Override
    public boolean changeOrderStatusBySpID(String shangpinid, int i, String dingdanid)
    {
        // TODO Auto-generated method stub
    ...
    @Override
    public boolean modifyOrderStatusBySpID(String shangpinid, int status, String salerId)
    {
        // TODO Auto-generated method stub
    ...
    public int addShuliang(OrderForApp order)
    {
        ...
        num = jdbcTemplate.update(sql, order.getShuliang(), order.getShangpinID());
        return num;
    ...
    @Override
    public boolean uploadPhoto(String userId, String type, String url, String fileName)
    {
        ...
        int count = jdbcTemplate.queryForObject(sql0, Integer.class ,userId, type);
        String sql1 = "";
        GeneratedKeyHolder generatedKeyHolder = new GeneratedKeyHolder();
        int id = 0;
        if (count > 0)
        {// 存在更新
            sql1 =
                "UPDATE yonghutouxiang SET Url = '" + url + "' WHERE YonghuID = '" + userId + "' and YonghuLx = '"
                    + type + "'";
        ...
        {// 不存在插入
            sql1 =
                "insert into yonghutouxiang(YonghuID,Url,JubaoZt,JubaoCs,ShanchuZt,RukuSj,TupianMc,YonghuLx) "
                    + "values(:userId,:url,:report_status,:report_count,:delete_status,Now(),:tupianmc,:userType)";
            
            this.namedJdbcTemplate.update(sql1, new BeanPropertySqlParameterSource(avatar), generatedKeyHolder);
            id = generatedKeyHolder.getKey().intValue();
            if (id > 0)
            {
                String sql2 = "";
    ...
    public boolean updateBuyerInfo(Buyer buyer)
    {
        ...
        {
            String sql =
                "update loginkehu set UserName=:name,Quyu=:quyu,weiboName=:weibo_name"
        ...
        {
            String sql =
                "update loginkehu set Quyu=:quyu,weiboName=:weibo_name"
    ...
    public boolean updateSalerInfo(Saler saler)
    {
        ...
        {
            String sql =
                "update loginshanghu set UserName=:name,Quyu=:quyu,weiboName=:weibo_name"
        ...
        {
            String sql =
                "update loginshanghu set Quyu=:quyu,weiboName=:weibo_name"
    ...
    public boolean modifyUserSize(UserSize size)
    {
        // TODO Auto-generated method stub
        String sql =
            "update yonghuchima set Name=:name,Chima=:normal_size,Shengao=:height,Tizhong=:weight,Yaowei=:waist,Tunwei=:hip,Xiongwei=:bust,Miaoshu=:description where ID=:id";
        int num = namedJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(size));
        return num > 0;
    }
    ...
    {
        String sql =
            "select ID as id,YonghuId as yonghuid,Shouhuoren AS shouhuoren,YonghuLx AS yonghulx,ShouhuoDizhi ,Dianhua as dianhua,Youbian as youbian ,Shengshiqu as shengshiqu from shouhuodizhi WHERE YonghuId=? and YonghuLx=?;";
        List<Address> mColorList =
            jdbcTemplate.query(sql,
                new Object[] {yonghuId, yonghuLx},
    ...
    public boolean changeBuyer(String oldId, String newId)
    {
        ...
        if (num > 0)
        {
            ...
            {
                // 将已修改的状态改回来
                String sql3 = "update dingdan set Zhuangtai = 1  WHERE ID=" + oldId;
     ...
     */
    @Override
    public int getNotSendOrderNum(String shangpinID, String maijiaID, String maijiaLx)
    {
        // TODO Auto-generated method stub
     ...
     */
    @Override
    public boolean hasQiangDan(String shangpinID, String MmaijiaID, String MmaijiaLx)
    {
        String sql =
            "select count(*) from dingdan where ShangpinID=? and MmaijiaID=? and MmaijiaLx=? and Zhuangtai in (0,1)";
        @SuppressWarnings("deprecation")
        int count = jdbcTemplate.queryForInt(sql, shangpinID, MmaijiaID, MmaijiaLx);
        return count > 0;
    }
    ...
    public int getLVByIDandLX(String maijiaID, String maijiaLx)
    {
        ...
        if (maijiaLx.equals("shanghu"))
        {
            ...
            List<LVBean> list = jdbcTemplate.query(sql2,new Object[] {maijiaID},new BeanPropertyRowMapper<LVBean>(LVBean.class));
            // 细分经验总和
            if(list != null && list.size() > 0){
    ...
    public int getLvByJingYan(int Jingyan)
    {
        ...
        try
        {
            ...
            int lv;
            lv = jdbcTemplate.queryForObject(sql, Integer.class , Jingyan, Jingyan);
            return lv;
        }
        catch (Exception e)
        {
    ...
    public LVBean getLVBeanByJingYan(int Jingyan)
    {
        ...
        {
            String sql =
                "SELECT jiagongfei as Y,jishu as dengji,JingyanMax FROM zhizuolxdj WHERE ? >= JingyanMin and ? <= JingyanMax";
            LVBean lv =
                jdbcTemplate.queryForObject(sql, new Object[] {Jingyan, Jingyan}, new BeanPropertyRowMapper<LVBean>(
                    LVBean.class));
            return lv;
        }
        catch (Exception e)
    ...
    public int getYByJingYan(int Jingyan)
    {
        ...
        try
        {
            ...
            int Y;
            Y = jdbcTemplate.queryForObject(sql, Integer.class , Jingyan, Jingyan);
            return Y;
        }
        catch (Exception e)
        {
    ...
    public boolean changeJingyanByPingfen(String order_id, int pingfen)
    {
        ...
        if (UserType.SALER.getValue().equals(order.getMmaijiaLx()))
        {// 卖家是商户,增加商户经验
         // 修改商户等级
        ...
        else
        {
            ...
            {
                return changeAllJingyan(changeJingyan, id, types, ZhizuoLxID)
                    && changeAllJingyan(changeJingyan, id, types, "0") ? true : false;
            }
        }
    }
    
    public boolean changeAllJingyan(int changeJingyan, String YonghuID, String YonghuLx, String ZhizuoLxID)
    {
        String sql =
            "UPDATE zhizuojingyan SET Jingyan = Jingyan+'" + changeJingyan + "' WHERE YonghuID = '" + YonghuID
                + "' AND YonghuLx = '" + YonghuLx + "' AND ZhizuoLxID = '" + ZhizuoLxID + "'";
        int num = jdbcTemplate.update(sql);
        int num2 = 0;
        if (num <= 0)
        {
            String sql2 =
                "insert into zhizuojingyan(Jingyan,YonghuID,YonghuLx,ZhizuoLxID,Dengji) values('" + changeJingyan
                    + "','" + YonghuID + "','" + YonghuLx + "','" + ZhizuoLxID + "','0')";
    ...
    public boolean changeJingyanByDianZan(String good_id, int dianzan)
    {
        ...
        if (UserType.SALER.getValue().equals(goods.getFabuzhelx()))
        {// 卖家是商户,增加商户经验
    ...
    {
        String sql =
            "UPDATE dingdan SET ShouhuoDianhua = :shouhuodianhua,ShouhuoDizhi=:shouhuodizhi,Shouhuoren=:shouhuoren,Youbian=:Youbian WHERE ID = :id";
        GeneratedKeyHolder generatedKeyHolder = new GeneratedKeyHolder();
        int num = this.namedJdbcTemplate.update(sql, new BeanPropertySqlParameterSource(order), generatedKeyHolder);
        return num > 0;
    }
    ...
    public boolean changeOrderPayCode(String dingdanid, String payCode)
    {
        ...
        try
        {
            ...
            if("1".equals(order.getZhuangtai()) || "16".equals(order.getZhuangtai()) || "8".equals(order.getZhuangtai())){
                int status = 8;
                if (order.getShangpinlx().equals("shejixiu"))
                {// 买断
                    status = 16;
                }
                String sql = "UPDATE dingdan set payCode = ?,Zhuangtai = " + status + " WHERE ID = ?";
    ...
    public boolean updateOrderStatus()
    {
        ...
        String sql =
            "UPDATE dingdan SET Zhuangtai='2' WHERE RukuSj < date_add(now(),interval -30 minute) and Zhuangtai in('0','1') and IsQiangdan='0'";
        int num = jdbcTemplate.update(sql);
        if (num > 0)
        {
            // 把失效订单移除
    ...
    public boolean jubao(PhotoBean photo)
    {
        ...
        {
            case 1:// 1.客户用户头像
                sql = "UPDATE yonghutouxiang SET JubaoZt=1,JubaoCs=JubaoCs+1 WHERE ID=" + id;
                break;
            case 2:// 2.商户用户头像
                sql = "UPDATE yonghutouxiang SET JubaoZt=1,JubaoCs=JubaoCs+1 WHERE ID=" + id;
                break;
            case 3:// 3.商品图片
                sql = "UPDATE shangpintupian SET JubaoZt=1,JubaoCs=JubaoCs+1 WHERE ID=" + id;
                break;
            case 4:// 4.模板图片
                sql = "UPDATE mubantupian SET JubaoZt=1,JubaoCs=JubaoCs+1 WHERE ID=" + id;
                break;
            default:
                break;
        }
    ...
    public int getNewDiscussCount(int designerId)
    {
        // TODO Auto-generated method stub
        String sql =
            "SELECT SUM(new_discuss_count) FROM shangpin WHERE FabuzheLx='shanghu' AND FabuzheID=? AND (Leixing='shejixiu' OR Leixing='chengyixiu')";
        Integer num = jdbcTemplate.queryForObject(sql, new Object[] {designerId}, Integer.class);
    ...
    public int getChangeCs(String loginId, String types)
    {
        ...
        int num = jdbcTemplate.queryForObject(sql, new Object[] {loginId}, Integer.class);
        return num;
    }
    ...
    public boolean isFenghao(String id, String types)
    {
        ...
        if (UserType.BUYER.getValue().equals(types))
        {
            ...
            num = jdbcTemplate.queryForObject(sql, new Object[] {id}, Integer.class);
        }
        else
        {
    ...
    public int getExp(String userId, String userType) {
    	...
    	if (UserType.BUYER.getValue().equals(userType)){
    		...
    		List<Integer> list = jdbcTemplate.queryForList(sql, new Object[]{userId}, Integer.class);
    		if(list != null && list.size() > 0){
    			exp = list.get(0);
    		}
    	}else{
    ...
    {
        // 生成收款码
        String shoukuanma = DateUtil.getDate(DateUtil.YYYY_MM_DD_HHMMSSSSS) + "-" + Utils.random6();
        ...
        if (num > 0)
        {
            ...
            num2 = jdbcTemplate.update(sql2, order.getShuliang(), order.getShangpinID());
    ...
    public StandardSize getStandardSize(String sex, String normalSize) {
    	...
    	List<StandardSize> list = jdbcTemplate.query(sql, new Object[]{sex, normalSize},new BeanPropertyRowMapper<StandardSize>(StandardSize.class));
    	return list.size() > 0 ? list.get(0) : null;
    }
