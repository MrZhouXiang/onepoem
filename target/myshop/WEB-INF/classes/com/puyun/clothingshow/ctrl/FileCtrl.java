...
import com.puyun.clothingshow.base.util.FileUtils;
import com.puyun.clothingshow.base.util.ImageUtils;
...
public class FileCtrl { 
     ...
     * @param type : int auto passed
     * @return LinkedList<FileMeta> as json format
     ****************************************************/
    @RequestMapping(value="/upload/{type}", method = RequestMethod.POST)
    public @ResponseBody FileMeta upload(MultipartHttpServletRequest request,@PathVariable int type) {
...
//          FileCopyUtils.copy(mpf.getBytes(), new FileOutputStream("D:/temp/files/"+mpf.getOriginalFilename()));
            ...
            File dirFile = new File(request.getSession().getServletContext().getRealPath(defPath));
            //创建目录
            if(!dirFile.exists()){
                dirFile.mkdirs();
            }
            ...
            String urlPath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort() ; //url路径
...
//                files.pop();
            ...
            try {
                ...
                //图片等比例压缩
                ImageUtils.resizeImg(realpath, realpath, width, height, true, forceResize);
...
//        return files;
     ...
     * <br>
     * author: 周震
     * date: 2015年9月25日 下午3:08:35
     * @param request
     * @return
     */
    @RequestMapping(value="/upload/apk", method = RequestMethod.POST)
    public @ResponseBody FileMeta uploadApk(MultipartHttpServletRequest request) {
    ...
    /***************************************************
     * URL: /controller/del/{type}
     * get(): get file as an attachment
     * @param fileName : passed by the server
     * @param type : type from the URL
     * @return void
     ****************************************************/
    @RequestMapping(value = "/del/{type}/{fileName}", method = RequestMethod.GET)
    public @ResponseBody Map<String,Object> del(@PathVariable String fileName,@PathVariable int type){
