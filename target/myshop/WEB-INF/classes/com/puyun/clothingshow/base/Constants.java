package com.puyun.clothingshow.base;
...
public class Constants
{
     ...
     * 头像图片路径
     */
    public static final String DEFAULT_AVATAR_PATH = RES_PATH + "/assets/avatar/";
    
    /**
     * 资讯图片路径
     */
    public static final String DEFAULT_INFO_PATH = RES_PATH + "/assets/img/info/";
    
    /**
     * 公告图片路径
     */
    public static final String DEFAULT_NOTI_PATH = RES_PATH + "/assets/img/noti/";
    
    /**
     * 活动图片路径
     */
    public static final String DEFAULT_PARTY_PATH = RES_PATH + "/assets/img/party/";
    
    /**
     * 供求图片路径
     */
    public static final String DEFAULT_SUPPLY_PATH = RES_PATH + "/assets/img/supply/";
    
    /**
     * 公司logo路径
     */
    public static final String DEFAULT_LOGO_PATH = RES_PATH + "/assets/img/logo/";
    
    /**
     * 产品路径
     */
    public static final String DEFAULT_PRODUCTION_PATH = RES_PATH + "/assets/img/production/";
    
    /**
     * 产品路径
     */
    public static final String DEFAULT_ORGANIZATION_PATH = RES_PATH + "/assets/img/organization/";
    
    /**
     * 资讯分类图片地址
     */
    public static final String DEFAULT_CATE_PATH = RES_PATH + "/assets/img/category/";
    
    /**
     * 照片地址
     */
    public static final String DEFAULT_PHOTO_PATH = RES_PATH + "/assets/img/photo/";
    
    /**
     * 下载二维码地址
     */
    public static final String TWO_DIMENSION_CODE_PATH = RES_PATH + "/assets/img/chamber_140.png";
    
    /**
     * 下载二维码的存放目录
     */
    public static final String TWO_DIMENSION_CODE_DIR = RES_PATH + "/assets/img";
     ...
     * 模板图片路径
     */
    public static final String DEFAULT_MODEL_PATH = RES_PATH + "/assets/img/model/";
    
    /**
     * 商品图片路径
     */
    public static final String DEFAULT_GOODS_PATH = RES_PATH + "/assets/img/goods/";
    
    /**
     * 聊天图片路径
     */
    public static final String DEFAULT_CHAT_PATH = RES_PATH + "/assets/img/chat/";
     ...
     * 
     * TODO	APP相关系统配置. 
     * Created on 2015年10月1日 上午10:01:38 
     * @author 周震
     */
