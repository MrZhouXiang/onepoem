...
public interface AppDao
{
     ...
     * @return
     */
    List<GoodsForApp> getGoodsList(String types, int page_num, int page_size, String orderby, int hascomment,
     ...
     * @return
     */
    List<HistoryShowForApp> getHistoryShowForApp(String types, int page_num, int page_size, String orderby,
     ...
     * @see [类、类#方法、类#成员]
     */
    List<GoodsForApp> getDesignerShowList(String types, int page_num, int page_size, String orderby, int hascomment,
        int comment_size, int id);
     ...
     * @return
     */
    boolean postComment(String commenter_id, String to_commenter_id, String types, String content,
        String pinglunrenLx);
     ...
     * @return
     */
    boolean postGoodsComment(String order_id, String shangpin_id, int pingfen, String content, String user_id,
        String utypes);
     ...
     * @return
     */
    List<Comment> getCommentList(String id, int page_num, int page_size, String types);
     ...
     * @see [类、类#方法、类#成员]
     */
    List<OrderForApp> getOrderList(String types, int userid, String status, int page_num, int page_size,
     ...
     * @see [类、类#方法、类#成员]
     */
    List<BuyerForOrder> getBuyerList(String id, int page_num, int page_size, String orderby);
     ...
     * 
     * @param id
     * @param status 1：待付款 2：已取消 4：已付款 8：待发货 32：已发货 64:已收货 128：待评价 256：已评价
     * @return
     * @see [类、类#方法、类#成员]
     */
     ...
     * @see [类、类#方法、类#成员]
     */
    int modifyOrderStatus(String id, int status, int kuaidiID, String kuaididanhao);
     ...
     * @see [类、类#方法、类#成员]
     */
    List<MouldForApp> getMouldList(String id, int page_num, int page_size, String orderby);
     ...
     * @see [类、类#方法、类#成员]
     */
    List<GoodsForApp> getGoodsList3(String types, int page_num, int page_size, String orderby, int hascomment,
        int comment_size, int yonghuid, int zhizuolx);
     ...
     * @see [类、类#方法、类#成员]
     */
    boolean modifyOrderStatusBySpID(String shangpingid, int status, String salerId);
     ...
     * @return
     */
    List<HistoryShowForApp> getHistoryShowForApp2(String types, int page_num, int page_size, String orderby,
