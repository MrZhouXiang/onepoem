...
<script type="text/javascript">
	...
	/* 跳转到用户尺寸详情 */	
	function usersizeDetail_Click(id) {

		location.href = "usersizeDetail.jsp?id=" + id;
	}
								...
								$("#table_findAllUser")
										.append(
												"<tr>'"
														...
														+ "</td>"
														+ "<td><a href='#' onclick='usersizeDetail_Click("
														+ data.result[i].id
														+ ")'>详情</a></td>"
														+ "</tr>");
							}
