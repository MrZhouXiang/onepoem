...
<script type="text/javascript">
	...
	function memberDetail_Click(id) {
		location.href = "buyerDetail.jsp?id=" + id;
	}
	
	/* 跳转到用户尺寸列表 */
	function userSizeList(id){
		location.href = "userSizeManage.jsp?id=" + id;
	}
	...
	function InitTable(pageIndex) {
		...
		$
				.ajax({
					url : "user/getBuyerList/" + currentPageVar,
					data : {
								...
								$("#table_findAllUser")
										.append(
												"<tr>'"
														...
														+ data.result[i].id
														+ ")'>详情</a></td>"
														+ "<td><a href='#' onclick='userSizeList("
														+ data.result[i].id
														+ ")'>修改尺寸</a></td>"
														+ "</tr>");
							}
				...
				<div class="row-fluid">
					...
					<div class="span10">
						<form class="form-inline" onsubmit="return false;">
							<font size="4">客户总数:<span id="all"></span> 被冻结数:<span
								id="lock"></span></font>
							...
							<input class="input-xlarge"
								style="float: right; margin-right: 10px" placeholder="请输入客户用户名"
								id="input_search" type="text">
						</form>
						<div class="well">
							<ul class="nav nav-tabs">
								<li id="active_li" class="active"><a href="#home"
									data-toggle="tab">全部客户</a></li>
								<li><a href="#profile" data-toggle="tab">冻结客户</a></li>
							</ul>
